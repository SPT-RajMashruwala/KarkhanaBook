...
// Code is generated on: 04-03-2022 11:40:49
//
...
namespace KarkhanaBookContext
{
    ...
    public partial class KarkhanaBookDataContext : Devart.Data.Linq.DataContext
    {
        ...
        partial void InsertFixedLookup(FixedLookup instance);
        partial void UpdateFixedLookup(FixedLookup instance);
        partial void DeleteFixedLookup(FixedLookup instance);
        ...
        public Devart.Data.Linq.Table<FixedLookup> FixedLookups
        {
            get
            {
                return this.GetTable<FixedLookup>();
            }
        }
...
namespace KarkhanaBookContext
{
    ...
    /// <summary>
    /// There are no comments for KarkhanaBookContext.FixedLookup in the schema.
    /// </summary>
    [Table(Name = @"dbo.FixedLookup")]
    public partial class FixedLookup : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// There are no comments for NameID in the schema.
        /// </summary>
        [Column(Storage = "_NameID", AutoSync = AutoSync.OnInsert, CanBeNull = false, DbType = "INT NOT NULL IDENTITY", IsDbGenerated = true, IsPrimaryKey = true)]
        public int NameID
        {
            get
            {
            ...
            set
            {
                if (this._NameID != value)
                {
                    ...
                    this.SendPropertyChanging("NameID");
                    this._NameID = value;
        ...
        /// <summary>
        /// There are no comments for Lookups in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="FixedLookup_Lookup", Storage="_Lookups", ThisKey="NameID", OtherKey="NameID", DeleteRule="NO ACTION")]
        ...
        {
            this.SendPropertyChanging("Lookups");
            entity.FixedLookup = this;
        }
    
        private void detach_Lookups(Lookup entity)
        {
            this.SendPropertyChanging("Lookups");
            entity.FixedLookup = null;
        }
    }

    /// <summary>
    /// There are no comments for KarkhanaBookContext.Lookup in the schema.
    /// </summary>
    ...
    public partial class Lookup : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<FixedLookup> _FixedLookup;
        ...
        public Lookup()
        {
            this._FixedLookup  = default(EntityRef<FixedLookup>);
            OnCreated();
        }

    
        /// <summary>
        /// There are no comments for ValueID in the schema.
        /// </summary>
        [Column(Storage = "_ValueID", AutoSync = AutoSync.OnInsert, CanBeNull = false, DbType = "INT NOT NULL IDENTITY", IsDbGenerated = true, IsPrimaryKey = true)]
        public int ValueID
        {
            get
            {
            ...
            set
            {
                if (this._ValueID != value)
                {
                    ...
                    this.SendPropertyChanging("ValueID");
                    this._ValueID = value;
        ...
        /// There are no comments for NameID in the schema.
        /// </summary>
        [Column(Storage = "_NameID", DbType = "INT", UpdateCheck = UpdateCheck.Never)]
        public int? NameID
        {
            get
            {
            ...
            set
            {
                if (this._NameID != value)
                {
                    if (this._FixedLookup.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        /// </summary>
        [Column(Storage = "_Value", DbType = "VARCHAR(100)", UpdateCheck = UpdateCheck.Never)]
        public string Value
        {
            get
            {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="FixedLookup_Lookup", Storage="_FixedLookup", ThisKey="NameID", OtherKey="NameID", IsForeignKey=true)]
        public FixedLookup FixedLookup
        {
            get
            {
                return this._FixedLookup.Entity;
            }
            set
            {
                FixedLookup previousValue = this._FixedLookup.Entity;
                if ((previousValue != value) || (this._FixedLookup.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("FixedLookup");
                    if (previousValue != null)
                    {
                        this._FixedLookup.Entity = null;
                        previousValue.Lookups.Remove(this);
                    }
                    this._FixedLookup.Entity = value;
                    if (value != null)
                    {
